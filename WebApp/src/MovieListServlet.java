           ...
           // BufferedWriter bw = new BufferedWriter(fw);
            ...
            try {
              ...
              //  Connection dbcon = dataSource.getConnection();
                ...
                totalTj += (endTj1 - startTj1);
             //   System.out.println("tj1 "+ (endTj1 - startTj1));
                ...
                if (!rs.isBeforeFirst()) {
                    ...
                    while (rs.next()) {
                        ...
                        totalTj += (endTj2 - startTj2);
                        //    System.out.println("tj2 "+ (endTj2 - startTj2));
                        ...
                        totalTj += (endTj3 - startTj3);

                        //  System.out.println("tj3 "+ (endTj3 - startTj3));
                        String genre = "genre";
                        int incr = 1;
                        while (r2.next()) {
                        ...
                        long startTj4 = System.nanoTime();
                        ResultSet r3 = s3.executeQuery();
                        long endTj4 = System.nanoTime();
                        //   System.out.println("tj4 "+ (endTj4 - startTj4));
                        totalTj = (endTj4 - startTj4);
